...
# Setup logging
log_file = 'distill_vit16_fixed_22.log'
...
distiller.compile(optimizer, criterion, distillation_loss_fn, alpha=0.1, temperature=7)
...
for epoch in range(num_epochs):
    ...
    if epoch_loss < best_val_loss:
        ...
        torch.save(student_model.state_dict(), '/tmp/best_student_vit16_model_fixed_22.pth')
...
plt.savefig('losses_plot_distilled_fixed_22.png')
plt.close()

# Reload the best model weights
student_model.load_state_dict(torch.load('/tmp/best_student_vit16_model_fixed_22.pth'))
...
plt.savefig('best_model_confusion_matrix_distilled_fixed_22.png')
plt.close()
